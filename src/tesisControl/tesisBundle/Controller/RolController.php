...
use tesisControl\tesisBundle\Entity\Rol;
use tesisControl\tesisBundle\Form\RolType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tesisControltesisBundle:Rol')->findAll();
     ...
     * @Method("POST")
     * @Template("tesisControltesisBundle:Rol:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('tesisControltesisBundle:Rol')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tesisControltesisBundle:Rol:edit.html.twig")
     */
