...
use tesisControl\tesisBundle\Entity\Carrera;
use tesisControl\tesisBundle\Form\CarreraType;
...
class CarreraController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tesisControltesisBundle:Carrera')->findAll();
     ...
     * @Method("POST")
     * @Template("tesisControltesisBundle:Carrera:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tesisControltesisBundle:Carrera:edit.html.twig")
     */
