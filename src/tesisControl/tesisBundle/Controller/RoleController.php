...
use tesisControl\tesisBundle\Entity\Role;
use tesisControl\tesisBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tesisControltesisBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("tesisControltesisBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('tesisControltesisBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tesisControltesisBundle:Role:edit.html.twig")
     */
