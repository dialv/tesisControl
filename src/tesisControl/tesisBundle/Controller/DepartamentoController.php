...
use tesisControl\tesisBundle\Entity\Departamento;
use tesisControl\tesisBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tesisControltesisBundle:Departamento')->findAll();
     ...
     * @Method("POST")
     * @Template("tesisControltesisBundle:Departamento:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('tesisControltesisBundle:Departamento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tesisControltesisBundle:Departamento:edit.html.twig")
     */
